...
// SIMULATED Combine result is never production recruitment evidence either way.
const ALLOW_COMBINE_CRITERIA = true;
  ...
  return (
    <div className="section" aria-label={t('m18.br.formLabel')}>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 8 }}>
        ...
        <label style={{ fontSize: 13 }}>
          {t('m18.br.fRadius')}{' '}
          <input type="number" style={{ width: 100 }} aria-label={t('m18.br.fRadius')} value={form.radiusKm ?? ''} onChange={(e) => set('radiusKm', num(e.target.value))} />
        </label>
        <label style={{ fontSize: 13 }}>
          {t('m18.br.fLevel')}{' '}
