...
const FIXTURES: Fixture[] = [
  { id: 'fix-d1', source: 'own', competition: 'U21 Development League', home: 'Eastport U21', away: 'Harbour Rovers U21', date: new Date(NOW + 6 * DAY).toISOString().slice(0, 10), location: { city: 'Manchester' } },
...
const ASSIGNMENTS: CoverageAssignment[] = [
  {
    id: 'cva-d1', fixtureLabel: 'Eastport U21 v Harbour Rovers U21', fixtureDate: FIXTURES[0].date, scoutName: 'Tom Field', scoutUserId: 'usr-d2',
...
const GROUPS: GroupRow[] = [{
  ...
  members: [{ id: 'org-eastport', name: 'Eastport Academy', level: 'pro' }, { id: 'org-hackneymarsh', name: 'Hackney Marsh Rovers', level: 'grassroots' }],
...
export const demoM13: M13Api = {
  ...
  groupReport: () => delay({
    ...
    activity: [{ orgName: 'Eastport Academy', assessments: 11, signings: '<3' }, { orgName: 'Hackney Marsh Rovers', assessments: 4, signings: '<3' }],
